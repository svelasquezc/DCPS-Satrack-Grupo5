            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>  
                            {section loop=$ide name=i }
                                <a  class="idea_descripcion" id="idea_descripcion_{$ide[i]->get('id')}" > {$ide[i]->get('descripcion')}</a>                 
                            {/section}
                    ...
                    <tr>
                        <td class="des1" id="desc1">
                            ...
                            <textarea id="textAread_id" name = "name_textArea" rows = "8" cols = "40" class = "input" WRAP ></textarea> </br>
